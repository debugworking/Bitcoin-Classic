...
const QString BITCOIN_IPC_PREFIX("btcc:");
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("btcc://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'btcc://' is not a valid URI. Use 'btcc:' instead."),
