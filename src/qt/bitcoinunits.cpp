...
{
    switch (unit) {
    case Unit::BTC: return QString("BTCC");
    case Unit::mBTC: return QString("mBTCC");
    case Unit::uBTC: return QString::fromUtf8("µBTCC");
...
QString BitcoinUnits::description(Unit unit)
{
    switch (unit) {
    case Unit::BTC: return QString("BTCC");
    case Unit::mBTC: return QString("Milli-BTCC (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-BTCC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
